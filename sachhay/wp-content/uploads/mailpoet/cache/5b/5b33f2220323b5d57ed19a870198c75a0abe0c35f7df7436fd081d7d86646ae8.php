...
class __TwigTemplate_63ebbb5cbfaa6813b593129652673f8c5de0065b36c4bd19987f9a65c797d26a extends \MailPoetVendor\Twig\Template
{
      ...
      <td>
        ...
        echo "
          ...
          <span>
            ";
        // line 59
        echo MailPoet\Util\Helpers::replaceLinkTags($this->env->getExtension('MailPoet\Twig\I18n')->translate("[link]Read guide[/link] on how to install Premium."), "https://kb.mailpoet.com/article/194-instructions-to-install-the-premium-plugin", ["target" => "_blank"]);
        // line 62
        echo "
           </span>
        </div>
...
";
    ...
    {
        return new Source("", "settings/premium.html", "C:\\xampp\\htdocs\\sachhay\\wp-content\\plugins\\mailpoet\\views\\settings\\premium.html");
    }
}
