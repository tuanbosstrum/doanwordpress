...
/* settings/mta.html */
class __TwigTemplate_3aa2ff201e18920e4bab03f573478caec130aefde73588ecace4cac3313551a0 extends \MailPoetVendor\Twig\Template
{
...
<script type=\"text/javascript\">
  jQuery(function(\$) {
    var tooltip = '";
        // line 665
        echo \MailPoetVendor\twig_escape_filter($this->env, \MailPoetVendor\twig_escape_filter($this->env, MailPoet\Util\Helpers::replaceLinkTags($this->env->getExtension('MailPoet\Twig\I18n')->translate("Didn't receive the test email? Read our [link]quick guide[/link] to sending issues."), "https://kb.mailpoet.com/article/146-my-newsletters-are-not-being-received", ["target" => "_blank"]), "js"), "html", null, true);
        // line 667
        echo "'
...
";
    ...
    {
        return new Source("", "settings/mta.html", "C:\\xampp\\htdocs\\sachhay\\wp-content\\plugins\\mailpoet\\views\\settings\\mta.html");
    }
}
